...
public class Constants {
    ...
    public static final String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/Aashish/user";
    public static final String DEFAULT_ROLE_NAME = "Aashish_user";
