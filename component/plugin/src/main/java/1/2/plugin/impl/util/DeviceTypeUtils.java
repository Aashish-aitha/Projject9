...
/**
 * Contains utility methods used by Aashish plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(1.2.plugin.impl.util.DeviceTypeUtils.class);
