...
/**
 * This represents the 2 implementation of DeviceManagerService.
 */
public class DeviceTypeManager implements DeviceManager {
    ...
    public boolean enrollDevice(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Enrolling a new 2 device : " + device.getDeviceIdentifier());
            }
            ...
            String msg = "Error while enrolling the 2 device : " + device.getDeviceIdentifier();
            log.error(msg, e);
    ...
    public boolean modifyEnrollment(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Modifying the 2 device enrollment data");
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while updating the enrollment of the 2 device : " +
    ...
    public boolean disenrollDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Dis-enrolling 2 device : " + deviceId);
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while removing the 2 device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public boolean isEnrolled(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Checking the enrollment of 2 device : " + deviceId.getId());
            }
            Device iotDevice =
            ...
            String msg = "Error while checking the enrollment status of 2 device : " +
                    deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
    ...
    public Device getDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Getting the details of 2 device : " + deviceId.getId());
            }
            device = deviceTypeDAO.getDeviceTypeDAO().getDevice(deviceId.getId());
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching the 2 device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return device;
    ...
    public boolean updateDeviceInfo(DeviceIdentifier deviceIdentifier, Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("updating the details of 2 device : " + deviceIdentifier);
            }
            DeviceTypeDAO.beginTransaction();
            status = deviceTypeDAO.getDeviceTypeDAO().updateDevice(device);
            DeviceTypeDAO.commitTransaction();
            ...
            String msg =
                    "Error while updating the 2 device : " + deviceIdentifier;
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public List<Device> getAllDevices() throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Fetching the details of all 2 devices");
            }
            devices = deviceTypeDAO.getDeviceTypeDAO().getAllDevices();
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching all 2 devices.";
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return devices;
